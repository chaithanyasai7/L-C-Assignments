...
public class CountryAdjacentFinder {
    ...
    public static void main(String[] args) {
        ...
        String inputCodes = scanner.nextLine().toUpperCase();

        String[] codesArray = inputCodes.split(",\\s*");

        for (String inputCode : codesArray) {
            String[] adjacentCountries = countryAdjacents.get(inputCode);
            System.out.println("Adjacent countries for " + inputCode + ":");
